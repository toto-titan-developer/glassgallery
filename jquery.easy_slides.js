...
(function ($) {
    ...
    $.fn.EasySlides = function (options) {
        ...
        return this.each(function () {
            ...
            var count = $(this_slider).children('*:not(.next_button, .prev_button, .nav_indicators, .exit_button)').length;
            var cur_slide = 0;
            ...
            if (count > 0) {
                ...
                while (count < settings['show']) {
                    ...
                    $(this_slider).children('.next_button:eq(0), .prev_button:eq(0), .nav_indicators:eq(0), .exit_button(0)').remove();
                    slides = $(this_slider).children('*:not(.next_button, .prev_button, .nav_indicators, .exit_button)');
